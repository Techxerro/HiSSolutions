                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 ">
                            <h1 data-aos="fade-up" data-aos-anchor-placement="center-center">Our Values Proposition</h1>
                        </div>

                        <div className="col-sm-4 col-12">
                            <div className="iconbox" data-aos="zoom-out-up" data-aos-anchor-placement="top-center">
